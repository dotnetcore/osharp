// -----------------------------------------------------------------------
//  <copyright file="IdentityResourcePropertyConfiguration.cs" company="OSharp开源团队">
...
namespace OSharp.IdentityServer4.EntityFrameworkCore
{
    ...
    /// 身份资源属性信息映射配置类
    /// </summary>
    public class IdentityResourcePropertyConfiguration : Id4EntityTypeConfigurationBase<IdentityResourceProperty, int>
    {
        /// <summary>
        /// 重写以实现实体类型各个属性的数据库配置
        /// </summary>
