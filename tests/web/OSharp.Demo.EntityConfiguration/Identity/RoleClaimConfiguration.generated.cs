...
// -----------------------------------------------------------------------
//  <copyright file="RoleClaimConfiguration.generated.cs" company="OSharp开源团队">
...
{
    /// <summary>
    /// 实体类-数据表映射——OSharp.Demo.Identity.Entities.RoleClaim
    /// </summary> 
    ...
    {        
        ...
        {
			RoleClaimConfigurationAppend();
        }

        /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void RoleClaimConfigurationAppend();
    }
}
