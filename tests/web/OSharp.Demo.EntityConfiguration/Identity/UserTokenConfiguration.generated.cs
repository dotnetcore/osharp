...
// -----------------------------------------------------------------------
//  <copyright file="UserTokenConfiguration.generated.cs" company="OSharp开源团队">
...
{
    /// <summary>
    /// 实体类-数据表映射——OSharp.Demo.Identity.Entities.UserToken
    /// </summary> 
    ...
    {        
        ...
        {
			UserTokenConfigurationAppend();
        }

        /// <summary>
        /// 额外的数据映射
        /// </summary>
        partial void UserTokenConfigurationAppend();
    }
}
