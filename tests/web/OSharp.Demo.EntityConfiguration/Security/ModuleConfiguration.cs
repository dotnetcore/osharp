    ...
    public class ModuleConfiguration : EntityTypeConfigurationBase<Module, int>
    {
        ...
        public override void Configure(EntityTypeBuilder<Module> builder)
        {
            ...
            builder.HasData(
                ...
                new Module() { Id = 4, Name = "身份认证模块", Remark = "身份认证模块节点", Code = "Identity", OrderCode = 1, ParentId = 3, TreePathString = "$1$,$3$,$4$" },
                new Module() { Id = 5, Name = "权限安全模块", Remark = "权限安全模块节点", Code = "Security", OrderCode = 2, ParentId = 3, TreePathString = "$1$,$3$,$5$" },
                new Module() { Id = 6, Name = "系统管理模块", Remark = "系统管理模块节点", Code = "System", OrderCode = 3, ParentId = 3, TreePathString = "$1$,$3$,$6$" }
            );
        }
    }
}