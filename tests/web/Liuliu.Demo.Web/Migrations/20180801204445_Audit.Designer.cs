...
namespace Liuliu.Demo.Web.Migrations
{
    ...
    [Migration("20180801204445_Audit")]
    partial class Audit
    {
            ...
            modelBuilder.Entity("Liuliu.Demo.Identity.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ConcurrencyStamp = "983e86bf-81a0-4f4c-afc5-c3085b995a32", CreatedTime = new DateTime(2018, 8, 2, 4, 44, 45, 481, DateTimeKind.Local), IsAdmin = true, IsDefault = false, IsLocked = false, IsSystem = true, Name = "系统管理员", NormalizedName = "系统管理员", Remark = "系统最高权限管理角色" }
                    );
                });
            ...
            modelBuilder.Entity("OSharp.System.KeyValueCouple", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("214c9d18-f463-4c0b-87ea-a930004e35ff"), IsLocked = false, Key = "Site.Name", ValueJson = "\"OSHARP\"", ValueType = "System.String" },
                        new { Id = new Guid("50ae37f0-244e-431b-ad8f-a930004e3604"), IsLocked = false, Key = "Site.Description", ValueJson = "\"Osharp with .NetStandard2.0 & Angular6\"", ValueType = "System.String" }
                    );
                });
