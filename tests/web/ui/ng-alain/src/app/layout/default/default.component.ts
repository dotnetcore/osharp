...
from '@shared/osharp/services/identity.service';
@Component( {
    ...
    mainActions=[];
    constructor( router: Router, scroll: ScrollService, private settings: SettingsService, private identity: IdentityService, _message: NzMessageService, ) {
